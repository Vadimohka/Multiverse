...
export function humanize(value:string){const labels:Record<string,string>={name:'Название',slug:'Slug',status:'Статус',created_at:'Создано',updated_at:'Обновлено',entry_url:'URL',source_type:'Тип',fetch_mode:'Загрузка',enabled:'Активен',version:'Версия',published_version:'Опубликовано',workflow_id:'Workflow',workflow_name:'Workflow',started_at:'Начало',finished_at:'Завершение',project_id:'Проект',model:'Модель',provider:'Provider',description:'Описание',default_timezone:'Часовой пояс',review_status:'Проверка',confidence:'Confidence',natural_key:'Ключ'};return labels[value]||value.replaceAll('_',' ')}
